	...
	<script>
		function fn_validate(){
			...
			if((userId.length==0 || userId=="") || (userPw.length==0 || userPw=="")) {
				...
				loginForm.method = "post";
				loginForm.action = "/project03/main/main/index.jsp";
				loginForm.submit();
			}
		}
	</script>
				...
				<div id="mainDisplay">
					<div id="sideMenu">
						...
						<div class="sideMenuContents">
							<ul>
								<li class="menuTitle firstMenu"><a href="../../sub02/main/index.jsp" class="menuTitleText" tabIndex="58">로그인</a></li>
								<li class="menuTitle"><a href="../../sub04/main/index.jsp" class="menuTitleText" tabIndex="59">아이디찾기</a></li>
								<li class="menuTitle"><a href="../../sub01/main/index.jsp" class="menuTitleText" tabIndex="60">비밀번호 재발급</a></li>
								<li class="menuTitle"><a href="../../sub02/main/index.jsp" class="menuTitleText" tabIndex="61">회원가입</a></li>
							</ul>
						</div>
					</div>
					<div id="loginBrowser">
						<form name="loginForm" id="loginForm" class="loginForm" method="post">
							<div class="loginGroup cf">
								<div class="loginArea">
									...
									<div class="checkArea">
										<a href="../../sub04/main/index.jsp" tabIndex="62">아이디 찾기</a>
										<a href="../../sub01/main/index.jsp" tabIndex="63">비밀번호 재발급</a>
										<a href="../../sub02/main/index.jsp" tabIndex="64">회원가입</a>
									</div>
								</div>
							</div>
						</form>
						<div class="loginDesc">
							<ul>
								<li>안양시 통합회원으로 가입한 경우 <a href="../../sub04/main/index.jsp" tabIndex="65">안양시신규회원등록(새창)</a> 페이지에서 최초 1회 로그인 후 안양시 홈페이지 이용이 가능합니다.</li>
